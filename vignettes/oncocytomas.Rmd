...
For whatever reason, vignette builds can fail if we plot all of the variants,
so we just plot the first two matched tumor-normal pairs here. 


```{r plotVariants}
plot(RONKScoding[1:4])
```
